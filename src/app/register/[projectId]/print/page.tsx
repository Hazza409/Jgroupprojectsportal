    ...
    <div className="min-h-screen bg-neutral-200 py-8 text-black print:bg-white print:py-0">
      ...
      <div className="mx-auto max-w-[900px] bg-white p-10 shadow-sm print:max-w-none print:p-0 print:shadow-none">
        ...
        <div className="mt-8 border-t border-neutral-200 pt-3 text-[10px] leading-relaxed text-neutral-500">
          ...
          <p className="mt-1.5">{PRINT_NOTICES.register}</p>
          {/* A register is evidence, and evidence gets read next to the
              contract. Say which one wins before anyone has to ask. */}
